...
| Tests | 10/10 passing (`test_strip_compatibility.py`) |
...
**Requires work**:
- PDF report generation needs decision on strip vs individual image layout
- Custom prompt file support (`--prompt-file`) not yet adapted for strip mode
:::
