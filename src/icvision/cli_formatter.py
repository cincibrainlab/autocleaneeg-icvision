...
class CLIFormatter:
    ...
    def _supports_color(cls) -> bool:
        ...
        return (
            ...
            sys.platform != 'win32'  # Basic check for color support
        )
    ...
    @classmethod
    def print_error(cls, message: str, details: Optional[str] = None, 
    ...
    def _print_usage_hint(cls) -> None:
        ...
        separator = "-" * 60
        print(f"{cls._colorize(separator, cls.GRAY)}")
        print(f"{cls._colorize('Usage:', cls.WHITE + cls.BOLD)} autoclean-icvision raw_data_path [ica_data_path] [options]")
